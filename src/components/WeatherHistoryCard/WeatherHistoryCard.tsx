...
import histClima from '../../data/hist-clima.json';
...
export default function WeatherHistoryCard({
  ...
  console.log('WeatherHistoryCard render: loading, error, items');
    ...
    return (
      <div className={`p-4 ${tokens.radius.lg} ${tokens.shadow.card} bg-white ${className}`}>
        <div className="flex items-center gap-3">
          <div className="p-2 bg-rose-100 rounded-full text-rose-600">⚠️</div>
          <div>
  ...
  console.log('WeatherHistoryCard items length:', items.length);
